...
## Core
Merchant subscription billing = seamless Lovable-managed Stripe (`enable_stripe_payments`). Do NOT propose Paddle or bring-your-own-key Stripe (`enable_stripe`) as alternatives.
