...
- Preserved the footer wording: © SEZA Technologies Inc. All rights reserved.
...
7. Review the homepage locally, then commit and push the changes to the GitHub branch connected to the SEZA deployment.
