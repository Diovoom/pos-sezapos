  ...
  public: {
    Tables: {
      ...
      business_trial_registry: {
        ...
        Relationships: [
          {
            foreignKeyName: "business_trial_registry_first_store_id_fkey"
            columns: ["first_store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
          },
      ...
      signup_risk_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "signup_risk_events_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
