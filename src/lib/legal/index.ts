...
import { privacyChoices } from "./docs/privacy-choices";
import {
  cookiePolicy,
  refundPolicy,
  acceptableUsePolicy,
...
export const LEGAL_CATEGORIES: Array<{
  id: LegalDocument["category"];
  label: string;
  description: string;
}> = [
  {
    ...
    description: "Agreements that govern use of the platform.",
  },
  {
    id: "Privacy",
    label: "Privacy & Data",
  ...
  },
  {
    id: "Policies",
    label: "Policies",
    description: "Rules and policies that keep the platform safe.",
  },
  {
    id: "Trust",
    label: "Trust & Security",
    description: "Our security, availability, and compliance posture.",
  },
