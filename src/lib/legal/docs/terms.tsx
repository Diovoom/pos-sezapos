  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            Subscription payments are securely processed by {C.billingProcessor} and are also
            subject to its applicable terms and privacy notice. Payment card details are tokenized
            and handled by the payment provider; SEZA does not store full card numbers on its own
            servers.
          </p>
          <p>
            For customer-facing card payments made through a connected Stripe Terminal account or
            another supported provider, the Merchant must maintain the required processor account
            and remains responsible for its products, customers, disputes, refunds, taxes, and
      ...
      body: (
        <>
          <p>
            ...
            failure within a reasonable time after notice from you, we may, at our discretion, issue
            a pro-rata refund for the affected period.
          </p>
          <p>
    ...
    },
    {
      ...
      body: (
        <ul>
          <li>
            Reselling, sublicensing, renting, or timesharing the Service without our written
            consent.
          </li>
          <li>
            Reverse engineering, decompiling, or attempting to extract source code, except as
            permitted by law.
          </li>
          ...
          <li>
            Using the Service to process payments for prohibited categories under applicable card
            network rules.
          </li>
      ...
      body: (
        <>
          <p>
            ...
            <a href="/legal/sla">Service Level Agreement</a>. The Service is provided on an "as
            available" basis, and no software service is guaranteed to be uninterrupted or
            error-free.
          </p>
        </>
      ),
      ...
      body: (
        <>
          <p>
            ...
            configuring the Service securely (for example, strong passwords, appropriate user roles,
            device security).
          </p>
        </>
      ),
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            Website: <a href={C.website}>{C.website}</a>
          </p>
        </>
      ),
    },
