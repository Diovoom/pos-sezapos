  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <>
          <p>
            The public SEZA website stores your cookie preference in local browser storage under{" "}
            <code>seza.cookie-consent.v1</code>. Strictly necessary storage is active by default.
            Optional analytics and marketing choices default to off unless you select them.
          </p>
          <p>
            Selecting an optional category records your preference, but a third-party tool will only
            receive data if SEZA has actually enabled that tool on the relevant page. Changing a
            preference does not retroactively delete information already processed by a third party;
            use the provider's controls or contact us for help where applicable.
          </p>
        </>
      ),
    },
...
export const refundPolicy: LegalDocument = {
  ...
  category: "Policies",
  summary: "The terms that apply when you cancel a subscription or request a refund from SEZA POS.",
  effectiveDate: C.effectiveDate,
  lastUpdated: C.lastUpdated,
  sections: [
    {
    ...
    },
    {
      ...
      body: (
        <p>
          Refund questions: <a href={`mailto:${C.supportEmail}`}>{C.supportEmail}</a>.
        </p>
      ),
    },
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <ul>
          <li>
            Anything illegal under applicable law, including the sale of prohibited or restricted
            goods without authorization.
          </li>
          <li>
            Fraudulent activity, deceptive business practices, or misrepresentation of goods or
            services.
          </li>
          ...
          <li>
            Unauthorized data collection, scraping, or bulk transmission of unsolicited messages.
          </li>
...
export const dpa: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <p>
          This page is informational and is not a signed data-processing agreement. Merchants that
          require a separate DPA or international-transfer terms should contact{" "}
          <a href={`mailto:${C.privacyEmail}`}>{C.privacyEmail}</a> before placing regulated data in
          the Service.
        </p>
      ),
    },
    ...
    },
    {
      ...
      body: (
        <p>
          ...
          <a href={`mailto:${C.securityEmail}`}>{C.securityEmail}</a>. Do not disrupt live stores,
          use social engineering, access unrelated data, or publicly disclose sensitive details
          before SEZA has a reasonable opportunity to investigate.
        </p>
      ),
    },
  ],
...
export const trademarkPolicy: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <ul>
          ...
          <li>
            Using our marks in a way that is misleading, defamatory, or associated with unlawful
            activity.
          </li>
        </ul>
      ),
    },
    {
      ...
      body: (
        <p>
          Report suspected misuse to <a href={`mailto:${C.legalEmail}`}>{C.legalEmail}</a>.
        </p>
      ),
    },
  ],
        ...
        <>
          ...
          <ol>
            ...
            <li>
              ...
              sufficient to permit us to locate it.
            </li>
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            We may request additional information or a physical delivery method when required to
            process a notice under applicable law.
          </p>
        </>
      ),
    },
...
export const apiTerms: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <ul>
          ...
          <li>
            Scraping, bulk exporting, or caching data beyond what is necessary for the integration.
          </li>
          <li>Circumventing rate limits, authentication, or logging.</li>
          <li>
            Storing full payment card numbers or authentication credentials outside of PCI-approved
            systems.
          </li>
        </ul>
      ),
    ...
    },
    {
      ...
      body: (
        <p>
          Developer relations: <a href={`mailto:${C.supportEmail}`}>{C.supportEmail}</a>.
        </p>
      ),
    },
  ],
...
export const accessibilityStatement: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <p>
          If you encounter an accessibility barrier or need information in another format, email{" "}
          <a href={`mailto:${C.supportEmail}`}>{C.supportEmail}</a>. Please include the page or
          feature, the assistive technology or device you used when relevant, and the problem you
          experienced. We will make reasonable efforts to respond and provide an accessible
          alternative.
        </p>
      ),
    },
...
export const compliance: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <p>
          Contact <a href={`mailto:${C.legalEmail}`}>{C.legalEmail}</a> before relying on SEZA for a
          regulated workflow or contractual compliance requirement.
        </p>
      ),
    },
  ],
  ...
  sections: [
    {
      ...
      body: (
        <p>
          Review the <a href="/security">Security page</a>,{" "}
          <a href="/legal/security-policy">Security Policy</a>,{" "}
          <a href="/legal/privacy">Privacy Policy</a>, and{" "}
          <a href="/legal/compliance">Compliance Information</a> for SEZA's current public
          statements. These pages are not independent certifications or audit reports.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <p>
          Email <a href={`mailto:${C.securityEmail}`}>{C.securityEmail}</a> with the affected page
          or feature, reproduction steps, potential impact, and a safe way to contact you. Please do
          not include unnecessary personal information or full payment credentials.
        </p>
      ),
    },
    {
