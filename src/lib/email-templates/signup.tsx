  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Welcome to <strong>{siteName}</strong>! You're one click away from your
        ...
        <Hr style={hr} />
        <Text style={footer}>
          This link expires in 24 hours. If you didn't create a {siteName} account, you can safely ignore this email.
        </Text>
        <Text style={footer}>
          © {new Date().getFullYear()} SEZA TECHNOLOGIES · <Link href={siteUrl} style={link}>{siteUrl.replace(/^https?:\/\//, '')}</Link>
        </Text>
      </Container>
    </Body>
  </Html>
...
const brandText = { fontSize: '18px', fontWeight: 700 as const, color: '#0f172a', margin: 0, letterSpacing: '-0.01em' }
...
const linkFallback = { fontSize: '12px', color: '#64748b', wordBreak: 'break-all' as const, margin: '0 0 12px' }
