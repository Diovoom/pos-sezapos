          ...
          >
            ...
            <div className="relative">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="rounded-full bg-white px-3 py-1.5 text-xs font-black uppercase tracking-[0.12em] text-blue-700">Compatibility first</span>
              </div>
              <h2 className="mt-5 text-balance text-3xl font-black tracking-[-0.035em] sm:text-4xl">Plan the complete setup built for your business.</h2>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-blue-50 sm:text-base">Review register, scanner, receipt-printer, cash-drawer, customer-display, and payment-reader requirements before you spend money on hardware.</p>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <Reveal className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            <div className="lg:pb-1">
              <p className="text-lg leading-8 text-slate-300">Use the SEZA compatibility guide to plan a complete setup for the way your business actually operates, then confirm exact model support before purchase.</p>
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <span className="inline-flex items-center rounded-full border border-white/15 px-4 text-sm text-slate-300">Exact model review required</span>
              </div>
            </div>
          </Reveal>
