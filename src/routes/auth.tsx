...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to your Velocity POS dashboard." },
    ],
  }),
  component: AuthPage,
});
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface p-4">
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{mode === "signin" ? "Sign in to your store" : "Create your store"}</CardTitle>
            <CardDescription>
              {mode === "signin"
                ? "Welcome back. Sign in to start ringing up sales."
                : "First user becomes the store owner. Add employees after."}
            </CardDescription>
          </CardHeader>
