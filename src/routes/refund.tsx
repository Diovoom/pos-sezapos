...
export const Route = createFileRoute("/refund")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SEZA POS offers a 30-day money-back guarantee on subscriptions." },
...
function RefundPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 prose prose-neutral">
      ...
      <p>Contact <a href="mailto:support@sezapos.com">support@sezapos.com</a> with your account email and order details, and we'll process your refund.</p>
      ...
      <p>After the 30-day window, you can cancel your subscription at any time from Settings → Billing. You will retain access until the end of your current billing period, but the remaining time is not refundable.</p>
    </div>
  );
}
