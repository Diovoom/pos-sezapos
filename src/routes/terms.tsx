...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SEZA POS LLC terms of service, including permitted use, intellectual property, and Paddle as Merchant of Record." },
...
function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-12 prose prose-neutral">
      ...
      <h2>1. Who we are</h2>
      <p>These Terms are an agreement between you and <strong>SEZA POS LLC</strong> ("SEZA POS", "we", "us"), the seller of the SEZA POS point-of-sale software (the "Service"). By creating an account, subscribing to a plan, or otherwise using the Service, you agree to these Terms.</p>
      ...
      <p>SEZA POS LLC owns the Service, including the software, documentation, and branding. We grant you a limited, non-exclusive, non-transferable right to use the Service within your selected plan. You retain ownership of the data you upload; you grant us a limited license to host and process that data solely to provide the Service.</p>
      ...
      <p>These Terms are governed by the laws of the jurisdiction in which SEZA POS LLC is established, without regard to conflict-of-laws principles. Disputes will be resolved in the competent courts of that jurisdiction.</p>
