...
}[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: "Payment terminal integration, cash tendering, split payments, and change calculation.",
      },
      {
        icon: RotateCcw,
        title: "Refunds & exchanges",
        body: "Full or partial refunds with restocking, void support, and manager overrides.",
      },
      {
        icon: Mail,
        title: "Email & SMS receipts",
        body: "Send digital receipts by email or text message, or print thermal receipts.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        body: "SKUs, variants, categories, cost & price, tax rules, and images.",
      },
      {
        icon: Boxes,
        title: "Stock tracking",
        body: "Automatic stock decrement on sale, restock on refund, and low-stock alerts.",
      },
      {
        icon: Wallet,
        title: "Register sessions",
        body: "Open/close registers with cash counts and end-of-shift reconciliation.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        body: "Owner, manager, and cashier roles with fine-grained permissions.",
      },
      {
        icon: Clock,
        title: "Time clock & payroll",
        body: "Clock in/out with PIN, late tracking, and payroll-ready reports.",
      },
      {
        icon: Shield,
        title: "Manager overrides",
        body: "Require manager approval for refunds, discounts, and price changes.",
      },
    ],
  },
  {
    ...
    items: [
      {
        icon: BarChart3,
        title: "Sales & shift reports",
        body: "Daily, weekly, and per-shift sales, taxes, tenders, and top items.",
      },
      {
        icon: Receipt,
        title: "Audit logs",
        body: "Every sensitive action is recorded with actor, target, and timestamp.",
      },
      {
        icon: Wifi,
        title: "Cloud sync",
      ...
      },
      {
        ...
        body: "Receipt printers, cash drawers, barcode scanners, customer displays.",
      },
      {
        icon: MessageSquare,
        title: "Customer profiles",
        body: "Track repeat customers, purchase history, and marketing consent.",
      },
    ],
  },
];
