...
const FAQS = [
  {
    ...
    a: "Every new merchant can start a 14-day trial without entering a payment card. The trial does not automatically charge you; an authorized owner chooses a paid plan through Stripe to continue paid access after the trial.",
  },
  {
    q: "Can I use my existing hardware?",
    a: "SEZA can work with supported scanners, ESC/POS-oriented receipt printers, printer-driven cash drawers, and configured payment readers. Compatibility depends on the exact model, connection, device, and required drivers or native plugins.",
  },
  {
    q: "How do I change my plan?",
    a: "Sign in and go to Settings → Billing. You can upgrade, downgrade, update your card, or cancel. Upgrades are prorated; downgrades apply at the next billing cycle.",
  },
  {
    q: "What happens if my internet goes down?",
    a: "Supported Android registers can record eligible cash sales in a limited offline mode and synchronize them after connectivity returns. Card payments and cloud-only functions still require a connection.",
  },
  {
    q: "How is my data backed up?",
    a: "Store data is held in the configured managed cloud environment and protected with provider and application safeguards. Export availability depends on the record type, and merchants should maintain appropriate accounting and continuity records.",
  },
  {
    q: "How do refunds work?",
    a: "Any sale can be fully or partially refunded from the Sales page. Refunds can restock inventory automatically and require manager approval by default.",
  },
  {
    q: "Do you support multiple stores?",
    a: "The platform is being prepared for expanded multi-store operations. Review the current pricing and product pages before relying on a specific multi-location workflow.",
  },
  {
    q: "How do I cancel?",
    a: "Go to Settings → Billing → Cancel plan. Your access continues through the end of your current billing period.",
  },
];
      ...
      <section className="max-w-6xl mx-auto px-6 pb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-xl border p-6 flex flex-col">
          ...
          <Button asChild variant="outline" className="mt-4">
            <Link to="/guide">Open user guide</Link>
          </Button>
        </div>
