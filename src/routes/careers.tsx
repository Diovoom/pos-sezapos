  ...
  head: () => ({
    meta: [
      { title: "Careers — SEZA POS" },
      {
        name: "description",
        content:
          "Join the team building modern point-of-sale software for independent retailers. Open roles and how to reach us.",
      },
      { property: "og:title", content: "Careers at SEZA POS" },
      {
        property: "og:description",
        content: "Help us build POS software that independent retailers actually love.",
      },
    ],
  }),
    ...
    <MarketingShell>
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-3 text-muted-foreground">
          ...
          with a note about what you'd want to work on.
        </p>
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          <Button asChild variant="outline">
            <Link to="/about">Learn about SEZA</Link>
          </Button>
        </div>
      </section>
    </MarketingShell>
