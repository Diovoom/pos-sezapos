const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/escpos-ble-BcGrRApQ.js","assets/chunk-QTnfLwEv.js","assets/preload-helper-zJ_50EbN.js"])))=>i.map(i=>d[i]);
import{t as e}from"./preload-helper-zJ_50EbN.js";import{n as t,r as n}from"./index-me7tGEn9.js";var r=e=>`$${Number(e||0).toFixed(2)}`,i=new TextEncoder;function a(e){return e===`80`?42:32}function o(e){return`-`.repeat(e)}function s(e,t,n){let r=Math.max(1,n-e.length-t.length);return e+` `.repeat(r)+t}function c(e){let t=e.reduce((e,t)=>e+t.length,0),n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.length;return n}async function l(l){let u=a(typeof window<`u`&&window.localStorage.getItem(`pos.receipt.paperWidth`)||`58`),d=n,f=[];f.push(d.init(),d.align(`center`),d.bold(!0),i.encode(`REGISTER SHIFT SUMMARY
...
`),d.cut());let p=t();if(p.id===`none`||!await p.isReady())return{ok:!1,error:`Printer is not configured.`};try{return await(await e(()=>import(`./escpos-ble-BcGrRApQ.js`).then(e=>e.t),__vite__mapDeps([0,1,2]))).write(c(f)),{ok:!0}}catch(e){return{ok:!1,error:e instanceof Error?e.message:`Printer error`}}}export{l as printShiftSummary};