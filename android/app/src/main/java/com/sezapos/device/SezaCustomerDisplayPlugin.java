...
public class SezaCustomerDisplayPlugin extends Plugin implements DisplayManager.DisplayListener {
    ...
    public void start(PluginCall call) {
        ...
        final String requestedIdlePayload = call.getString("idlePayload", null);
        lastPayload = requestedIdlePayload != null && !requestedIdlePayload.trim().isEmpty()
            ? requestedIdlePayload
            : idlePayload(storeName);
    ...
    private String idlePayload(String name) {
        try {
            ...
            payload.put("idleMode", "message");
            payload.put("idleMessage", "Welcome");
            payload.put("idleImageUrl", JSONObject.NULL);
            payload.put("idleTextScale", 1);
